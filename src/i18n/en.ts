const en = {
  ...
  'center.regionRoute.subtitle': '{n} region route group(s)',
  'center.regionRoute.serviceGroup': 'Service Group',
  'center.regionRoute.cluster': 'Cluster',
  'center.regionRoute.namespace': 'Namespace',
  'center.regionRoute.controllers': 'Controllers',
  'center.regionRoute.resourceCount': 'Resources',
  'center.regionRoute.noData': 'No region route groups found',
  ...
  'center.regionRoute.fetchError': 'Failed to fetch from {id}',
  'center.regionRoute.controller': 'Controller',
